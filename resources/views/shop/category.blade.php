                      ...
                      <div class="product">
                        <div class="product-image">
                          ...
                          <a href="{{ url('details/'.$data->id) }}">
                             <img src="{{ Storage::url('product/main/m/'.$data->image) }}" alt="">
                              <img src="{{$data->image}}" alt="" class="hover-image">
                          </a>
                       </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="{{ url('details/'.$data->id) }}">{{mb_strimwidth($data->p_name,0,20)}}</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price">${{$data->price}} </span> <span class="price-before-discount">$ 800</span> </div>
                          <!-- /.product-price -->

...
@foreach ($data as $dataaa)
                  ...
                  <div class="item">
                    <div style="" class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image">
                          <a href="{{ url('details/'.$dataaa->id) }}">
                             <img src="{{ Storage::url('product/main/m/'.$dataaa->image) }}" alt="">
                              <img src="{{$dataaa->image}}" alt="" class="hover-image">
                          </a>
                       </div>
                          <!-- /.image -->
                        ...
                        <div class="product-info text-left">
                          <h3 class="name"><a href="{{ url('details/'.$dataaa->id) }}">{{mb_strimwidth($dataaa->p_name,0,20)}}</a></h3>
                          <div class="rating rateit-small"></div>
                          <div class="description"></div>
                          <div class="product-price"> <span class="price">${{$dataaa->price}} </span> <span class="price-before-discount">$ 800</span> </div>
                          <!-- /.product-price -->

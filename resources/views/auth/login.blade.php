...
<div class="col-md-6 col-sm-6 create-new-account">
    ...
    <form action="{{route('register')}}" method="post" class="register-form outer-top-xs" role="form">
        ...
        <div class="form-group">
            <label class="info-title" for="Address">Primery Address <span>*</span></label>
        ...
        <div class="form-group">
            ...
            <input name="state" type="text" class="form-control unicase-form-control text-input"  >
            @error('state')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="form-group">
            ...
            <input name="city" type="text" class="form-control unicase-form-control text-input"  >
            @error('city')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input name="pincode" type="text" class="form-control unicase-form-control text-input"  >
            @error('pincode')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input name="country" type="text" class="form-control unicase-form-control text-input">
            @error('country')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <input name="password_confirmation" type="password" class="form-control unicase-form-control text-input"  >
        </div>

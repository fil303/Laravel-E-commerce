        ...
        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 animate-dropdown top-cart-row">
          ...
          <div class="dropdown dropdown-cart"> <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
            <div class="items-cart-inner">
              <div class="basket">
              <div class="basket-item-count"><span class="count">{{ Cart::instance( auth()->id() )->content()->count() }}</span></div>
              <div class="total-price-basket"> <span class="lbl">Shopping Cart</span> <span class="value">${{ Cart::instance( auth()->id() )->initial() }}</span> </div>
              </div>
            </div>
            </a>
...
@php
  {{ $dataa = App\Models\Categorie::with('getsub')->get(); }}
  {{ $i = 0; }}
  {{ $a = 0; }}
@endphp
                      ...
                      <div class="yamm-content ">
                        <div class="row">
                          <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                            <ul class="links">
                              @foreach ($data->getsub as $dat)
                              @php
                                {{ $i++; }}
                              @endphp
                                    <li><a href="{{ url('/categorie/'.$data->id.'/product/'.$dat->id) }}">{{ $dat->name }}</a></li>
...
<footer id="footer" class="footer color-bg">
  ...
  <div class="copyright-bar">
    <div class="container">
      ...
      <div class="col-xs-12 col-sm-4 no-padding copyright"> CopyRight @ 2020 </div>
